...
このページでは、株式会社インサイト・ファクトリー 2020年度社内研修「[マーケティング・ミックス・モデリング](http://elsur.jpn.org/202004MMM)」IV章「静学的市場反応モデル」のRコードを公開しています。
...
とする。
いっぽうシェアモデルは、対数中心化したシェア $S^*_{bi}$について
...
いま、$b=j$のとき$1$, そうでないときに$0$となる関数を$I(b,j)$とすれば
